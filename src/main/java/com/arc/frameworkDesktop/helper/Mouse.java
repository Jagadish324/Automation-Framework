...
public class Mouse extends CommonHelper {
    ...
    public static void mouseClick(By locator)
    {
        ...
        action.moveToElement(desktopDriver.findElement(locator)).click().build().perform();
    }
    /**
    ...
    public static void drawInCanvas(By canvasLocator){
        action = new Actions(desktopDriver);
        Action draw = action.contextClick(com.arc.frameworkWeb.helper.CommonHelper.getElement(canvasLocator))
                .moveToElement(com.arc.frameworkWeb.helper.CommonHelper.getElement(canvasLocator),50,100)
                .clickAndHold(com.arc.frameworkWeb.helper.CommonHelper.getElement(canvasLocator)).moveByOffset(50,110).release(CommonHelper.getElement(canvasLocator)).build();
        draw.perform();
    }

//    public static int getMouseXCoordinate(){
//        PointerInput pointer = new PointerInput(PointerInput.Kind.MOUSE, "mouse");
//
//        // Get the current mouse coordinates
//        Origin origin = pointer.createPointerMove(0, 0, 0, 0).origin();
//
//        // Perform the action to get the current mouse coordinates
//        PointerActions actions = new PointerActions();
//        actions.pointerMove(origin, 0, 0).perform();
//
//        // Get the current mouse coordinates
//        int x = actions.getX();
//        int y = actions.getY();
